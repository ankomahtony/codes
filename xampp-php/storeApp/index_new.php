<?php
	...
	$company_query = mysqli_query($connection, "SELECT * FROM company WHERE id = $id");
		...
		<h1 class="my-4"></h1>
		 ...
		 <div class="col-lg-10">
			<div class="tab-content" id="v-pills-tabContent">
			  <div class="tab-pane fade" id="v-pills-item" role="tabpanel" aria-labelledby="v-pills-item-tab">
				<div class="card card-outline-secondary my-4">
				  <div class="card-header" style="color: orange; font-size: 18pt;">Item Details</div>
				  <div class="card-body">
			...
			<div class="tab-pane fade show active" id="v-pills-sale" role="tabpanel" aria-labelledby="v-pills-sale-tab">
				<div class="card card-outline-secondary my-4">
				  <div class="card-header" style="color: orange; font-size: 18pt;">Sale Details</div>
				  <div class="card-body">
			  ...
			  <div class="tab-pane fade" id="v-pills-customer" role="tabpanel" aria-labelledby="v-pills-customer-tab">
				<div class="card card-outline-secondary my-4">
				  <div class="card-header" style="color: orange; font-size: 18pt;">Customer Details</div>
				  <div class="card-body">
				  <!-- Div to show the ajax message from validations/db submission -->
			  ...
			  <div class="tab-pane fade" id="v-pills-search" role="tabpanel" aria-labelledby="v-pills-search-tab">
				<div class="card card-outline-secondary my-4">
				  <div class="card-header" style="color: orange; font-size: 18pt;">Search Inventory<button id="searchTablesRefresh" name="searchTablesRefresh" class="btn btn-warning float-right btn-sm">Refresh</button></div>
				  <div class="card-body">										
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item">
			  ...
			  <div class="tab-pane fade" id="v-pills-reports" role="tabpanel" aria-labelledby="v-pills-reports-tab">
				<div class="card card-outline-secondary my-4">
				  <div class="card-header" style="color: orange; font-size: 18pt;">Reports<button id="reportsTablesRefresh" name="reportsTablesRefresh" class="btn btn-warning float-right btn-sm">Refresh</button></div>
				  <div class="card-body">										
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item">
			  ...
			  <div class="tab-pane fade" id="v-pills-account" role="tabpanel" aria-labelledby="v-pills-reports-tab">
				<div class="card card-outline-secondary my-4">
				  <div class="card-header" style="color: orange; font-size: 18pt;">Accounts<button id="accountsTablesRefresh" name="accountsTablesRefresh" class="btn btn-warning float-right btn-sm">Refresh</button></div>
				  <div class="card-body">										
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="#cashReportsTab">Cash in Hand</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#bankReportsTab">Bank Account</a>
						</li>

						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#pettyReportsTab">Petty Cash</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#transferReportsTab">Transfer</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#summaryReportsTab">Summary</a>
						</li>
					</ul>
  
					<!-- Tab panes for reports sections -->
					<div class="tab-content">
						<div id="cashReportsTab" class="container-fluid tab-pane active">
							<br>
							<form> 
							  <div class="form-row">
								  <div class="form-group col-md-3">
							...
							<br><br>
							<p>Use the grid below to get reports for Cash Book</p>

							<div class="table-responsive" id="itemReportsTableDiv"></div>
						</div>
						<div id="bankReportsTab" class="container-fluid tab-pane fade">
							<br>
							<form> 
							  <div class="form-row">
								  <div class="form-group col-md-3">
							...
							<br><br>
							<p>Use the grid below to get reports for Bank Account</p>
							<div class="table-responsive" id="customerReportsTableDiv"></div>
						</div>
						<div id="pettyReportsTab" class="container-fluid tab-pane fade">
							<br>
							<!-- <p>Use the grid below to get reports for sales</p> -->
							<form> 
							  <div class="form-row">
						...
						<div id="transferReportsTab" class="container-fluid tab-pane fade">
							<br>
							<!-- <p>Use the grid below to get reports for purchases</p> -->
							...
							<form>
							  <div class="form-row">
								<div class="form-group col-md-3">
								  <label for="saleDetailsItemNumber">Transaction ID<span class="requiredIcon">*</span></label>
								  <input type="text" class="form-control" id="saleDetailsItemNumber" name="saleDetailsItemNumber" autocomplete="off">
								  <div id="saleDetailsItemNumberSuggestionsDiv" class="customListDivWidth"></div>
								</div>
								<div class="form-group col-md-3">
							  ...
							  <button type="button" id="addSaleButton" class="btn btn-success">Transfer</button>
							  <button type="button" id="updateSaleDetailsButton" class="btn btn-primary">Update</button>
							  <button type="reset" id="saleClear" class="btn">Clear</button>
							</form>
						</div>
						<div id="summaryReportsTab" class="container-fluid tab-pane fade">
							<br>
							<form> 
							  <div class="form-row">
								  <div class="form-group col-md-3">
							...
							<br><br>
							<p>Use the grid below to get reports for Summary </p>
							<div class="table-responsive" id="vendorReportsTableDiv"></div>
						</div>
					</div>
				  </div> 

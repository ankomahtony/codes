            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="active has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-home"></i>Messages</a>
                        </li>
                        <hr/>
                    </ul>
                </nav>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    ...
                                    <a href="exeat_form/exeat_form.php">
                                    <button class="au-btn au-btn-icon au-btn--blue">
                                        <i class="zmdi zmdi-plus"></i>Issue Exeat</button>
                                    </a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <h2>Town Exeat </h2>
                                                <hr>
                                                <p><span>Student Returned: 50</span></p>
                                                <p><span>Student Left:     20</span></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="table-responsive table--no-card m-b-30">
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <tbody>
                                            <?php  
                                                $query_exeat = mysqli_query($connection, "SELECT * FROM exeat WHERE remark = 'No' ");
                                                $count = 1;
                                                while ($row = mysqli_fetch_array($query_exeat)) {
                                                 $your_date = strtotime($row['date_of_returning']);
                                                $now = time();
                                                $date_diff = $your_date -$now;
                                                $date_diff_round= round($date_diff/(60*60*24));
                                            ...
                                            echo  '<tr>
                                                ...
                                                <td>'.$row['remark'].'</td>
                                                <td>'.$days_left.'</td>
                                                <td><a href="return_exeat.php?id='.$row['id'].'" title="Return Exeat" onclick="return confirm(\'Are you sure '.$row['name_of_student'].' has return?'.'?\')" class="btn btn-success btn-sm"><span class="zmdi zmdi-plus" aria-hidden="true"></span></a>
                            </td>
                                            </tr> ';
                                                $count++;
                                                }
